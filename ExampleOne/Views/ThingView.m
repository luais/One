...
@property (nonatomic,strong) UIActivityIndicatorView *indicatorView; //加载转菊花
...
- (void)setUpViews
{
    ...
    //初始化东西名字文字控件
    self.thingNameLabel = [[UILabel alloc]init];
    ...
    [self.thingDescriptionTextView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.thingNameLabel.mas_bottom).offset(25);
